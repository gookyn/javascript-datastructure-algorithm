...
const { BinarySearchTree } = require('../../../src/data-structures');
...
describe('Binary Search Tree', () => {
	...
	it('post order traverse the BST', () => {
		insertNode(tree);
	...
	it('return the min and max elements of the BST', () => {
		insertNode(tree);
